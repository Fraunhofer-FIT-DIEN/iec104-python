...
/**
 * @brief Enumerates the information class categories
 */
enum InformationCategory {
  MONITORING_STATUS,  // interrogation
  MONITORING_COUNTER, // counter-interrogation
  MONITORING_EVENT,   // monitoring: SPONTANEOUS
  COMMAND,   // control: ACT, DEACT | monitoring: ACT_CON, DEACT_CON, ACT_TERM,
             // ERROR (DEACT if select and execute)
  PARAMETER, // control: ACT | monitoring: ACT_CON, INTERROGATION, ERROR
};
