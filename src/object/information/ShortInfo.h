...
#ifndef C104_OBJECT_INFORMATION_M_ME_C_H
#define C104_OBJECT_INFORMATION_M_ME_C_H
 ...
 */
class ShortInfo : public IInformation {
protected:
...
#endif // C104_OBJECT_INFORMATION_M_ME_C_H
