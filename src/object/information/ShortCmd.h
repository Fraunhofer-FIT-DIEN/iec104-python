...
#ifndef C104_OBJECT_INFORMATION_C_SE_C_H
#define C104_OBJECT_INFORMATION_C_SE_C_H
 ...
 */
class ShortCmd : public ICommand {
protected:
...
public:
  ...
  create(const float target,
    ...
    return std::make_shared<ShortCmd>(
        target, false, std::visit(visitor2, qualifier), recorded_at, false);
  }
...
#endif // C104_OBJECT_INFORMATION_C_SE_C_H
