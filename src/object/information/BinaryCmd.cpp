...
std::shared_ptr<BinaryCmd>
BinaryCmd::create(const std::variant<Byte32, py::bytes, int32_t> blob,
  ...
  return std::make_shared<BinaryCmd>(std::visit(visitor, blob), recorded_at,
                                     false);
}
